    ...
    <div style={{ marginTop:'4rem' }}>
        ...
        <div className="p-5 container h-25">
          <div className="d-flex justify-content-between">
            <div className="d-flex align-items-center">
              {/* <div className="mx-3">
                <img src={poolStat.name} alt={poolStat.name} className="img-fluid" style={{ width:'50px' }} />
                <img src={poolStat.name} alt={poolStat.name} className="img-fluid" style={{ width:'50px' }} />
              </div> */}
      ...
      <div className="container d-flex my-3 justify-content-center">
        ...
        <div className="col-4 rounded-3 mx-2">
          ...
          <div className="d-flex flex-column my-3 rounded-3 flex-wrap">

            <div className='col-5 bg-primary p-3 box rounded-2 text-light shadow-4 w-100'>
      ...
      <div className="container m-5 col-12 d-flex flex-column justify-content-center">
          <h2>Transsactions</h2>
